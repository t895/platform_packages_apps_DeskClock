...
class SimpleMenuPreference(
    ...
    private class SimpleMenuAdapter internal constructor(context: Context, resource: Int) :
        ...
        override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if (position == 0) {
                view.setBackgroundColor(ThemeUtils.resolveColor(context, R.attr.colorPrimaryContainer))
            } else {
                view.setBackgroundColor(ThemeUtils.resolveColor(context, R.attr.colorSurfaceContainer))
            }
            return view
        }
    }
